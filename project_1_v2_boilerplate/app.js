...
class ApplicationServer {
	...
	constructor() {
		...
		// this.app.get("/add", (req, res, next) => {
		// 	let p = this.blockchain.submitStar("address", "message", "signature", "star");
		...
		// 	let p = this.blockchain.requestMessageOwnershipVerification(wallet);
		// 	p.then( e => 	console.log("Please sign the next message in your application:", e) );
		// 	res.json(p)
		// });
