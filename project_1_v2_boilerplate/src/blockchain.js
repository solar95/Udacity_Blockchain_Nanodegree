...
class Blockchain {
    ...
    _addBlock(block) {
        let self = this;
        const chainSize = self.chain.length;

        console.log("Longitud: ", chainSize);
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(chainSize == 0){
                console.log("This is a Genesis Block");
            }

            else{
                block.previousBlockHash = self.chain[chainSize-1].hash;
            }
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (currentTime < (messageTime + (5 * 60))) { 
                ...
                reject('It has been more than 5 minutes, the signature is no longer valid!');
            }
        });
    }
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            for(let e in self.chain){

                if(self.chain[e].hash == hash){
                    resolve(self.chain[e])
                }
            }
